...
import com.commerce.ordersystem.product.repository.ProductRepository;
...
//            기존 이미지가 null이 아닌경우(기존 이미지가 있었던 경우)에만 이미지 삭제
    ...
    public void updateStock(ProductStockUpdateDto dto){
        Product product = productRepository.findById(dto.getProductId()).orElseThrow(()-> new EntityNotFoundException("product cannot be found"));
