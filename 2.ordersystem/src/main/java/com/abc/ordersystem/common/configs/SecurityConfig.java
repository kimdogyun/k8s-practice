...
import com.abc.ordersystem.common.auth.JwtTokenFilter;
import com.abc.ordersystem.common.exception.JwtAuthenticationHandler;
...
public class SecurityConfig {
    ...
    //    내가 만든 클래스와 객체는 @Component,
//    외부 클래스(라이브러리)를 활용한 객체는 @Configuration + @Bean
//    @Component는 클래스 위에 붙여 클래스 기반에 객체를 싱글톤객체로 생성.
...
//        허용 가능한 도메인 목록 설정
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "https://www.dannn323.shop"));
